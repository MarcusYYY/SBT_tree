...
public class SparseBackoffTreeStructure {
    ...
    //	public ArrayList<ArrayList<SparseBackoffTreeStructure>> get_SBT_node_Array(SparseBackoffTreeStructure root){
    //		if(root == null) return;
    //
    //	}
    ...
    public static boolean testRandomLeaf() {
        ...
        //		}
        System.out.println("Test of Random leaf and the branching factor is [[2],[1,2],[1,2,3]]");
    ...
    public static boolean testExtract(){
        ...
        System.out.println("Test of testExtract()");
        if (pass_)
        ...
        System.out.println(struct._children[1].numLeaves());
        struct.SBT_grow(sublist_4, struct, 0.5);
        int leaf = 0;
        int [] trace = struct.getLocalIdxTrace(leaf);
        double [] discounts = struct.getDiscountTrace(trace);
        //	    for (double dis : discounts)
